...
import org.example.tugas_modul6.loginStudent_GUI;

public class LibrarySystem {
    private static Admin objAdmin = new Admin();
    private static loginStudent_GUI objGUILoginStudent = new loginStudent_GUI();
    ...
    public static Object[] checkNim() {
        ...
        for (String string : nimStudentList) {
            if (string.equals(nimStudentListHolder)) {
                // nim telah didaftarkan oleh admin
                object[0] = 1;
                return object;
